...
public enum ClaudeSettings {
    ...
    public static func skillOverrides(env: ACMEnvironment) -> [String: String] {
    ...
    public static func setSkillOverride(_ name: String, to value: String?, env: ACMEnvironment) throws {
        let settings = (try? JSONConfig.read(env.claudeSettings)) ?? [:]
