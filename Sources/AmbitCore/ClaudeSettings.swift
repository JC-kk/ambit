...
public enum ClaudeSettings {
    ...
    public static func skillOverrides(env: AmbitEnvironment) -> [String: String] {
    ...
    public static func setSkillOverride(_ name: String, to value: String?, env: AmbitEnvironment) throws {
        let settings = (try? JSONConfig.read(env.claudeSettings)) ?? [:]
